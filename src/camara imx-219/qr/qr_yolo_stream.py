"""
qr_yolo_stream.py  —  Detector QR + YOLOv8  —  Picamera2 (IMX219) + Streaming Web (Flask)
===================================================================================
...
Uso:
    ...
    python qr_yolo_stream.py --weights runs/train/mi_modelo/weights/best.pt

    # Entrenar y luego iniciar el stream
    python qr_yolo_stream.py --train --data mi_dataset.yaml --epochs 50
