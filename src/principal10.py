...
UMBRAL_CURVA     = 80     # error en px para considerar curva (usado con offset)
OFFSET_CURVA     = 0      # offset en px al estar en curva y solo ver roja (ajustar)
VEL_BASE    = 50
VEL_MIN     = 25
VEL_MAX     = 75
INTERVALO_S = 0.1
...
def _navegar_pid(segundos):
    ...
    while time.time() - t0 < segundos:
        ...
        if error is not None:
            ...
            en_curva = solo_roja and abs(error) > UMBRAL_CURVA
