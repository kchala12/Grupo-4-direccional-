...
# Mapa letra → palabra para la ESP32
_DIR_MAP = {"f": "adelante", "b": "atras", "l": "izquierda", "r": "derecha", "s": "stop"}
...
def set_velocidades(vel_izq: int, vel_der: int, dir_letra: str):
    ...
    """
    dir_esp = _DIR_MAP.get(dir_letra, "adelante")
